...
public class RawWorkflowsClient {
   ...
   * Retrieves all workflow definitions for the authenticated user
   */
  public PhenoMLHttpResponse<ListWorkflowsResponse> list(RequestOptions requestOptions) {
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListWorkflowsResponse.class), response);
        }
        try {
    ...
    public PhenoMLHttpResponse<CreateWorkflowResponse> create(CreateWorkflowRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateWorkflowResponse.class), response);
          }
          try {
            switch (response.code()) {
      ...
      public PhenoMLHttpResponse<WorkflowsGetResponse> get(String id, WorkflowsGetRequest request,
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
              return new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, WorkflowsGetResponse.class), response);
            }
            try {
              switch (response.code()) {
                case 401:throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
         ...
         */
        public PhenoMLHttpResponse<WorkflowsUpdateResponse> update(String id,
        ...
        public PhenoMLHttpResponse<WorkflowsUpdateResponse> update(String id,
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, WorkflowsUpdateResponse.class), response);
              }
              try {
                switch (response.code()) {
                  case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
          ...
          public PhenoMLHttpResponse<WorkflowsDeleteResponse> delete(String id,
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              try (Response response = client.newCall(okhttpRequest).execute()) {
                ...
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  return new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, WorkflowsDeleteResponse.class), response);
                }
                try {
                  switch (response.code()) {
                    case 401:throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
             ...
             */
            public PhenoMLHttpResponse<ExecuteWorkflowResponse> execute(String id,
            ...
            public PhenoMLHttpResponse<ExecuteWorkflowResponse> execute(String id,
              ...
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                try (Response response = client.newCall(okhttpRequest).execute()) {
                  ...
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    return new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ExecuteWorkflowResponse.class), response);
                  }
                  try {
                    switch (response.code()) {
                      case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
