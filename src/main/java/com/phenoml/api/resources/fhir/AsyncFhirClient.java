...
public class AsyncFhirClient {
  ...
  public CompletableFuture<FhirSearchResponse> search(String fhirProviderId, String fhirPath,
    ...
    return this.rawClient.search(fhirProviderId, fhirPath, request, requestOptions).thenApply(response -> response.body());
  }
   ...
   * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
   */
  public CompletableFuture<FhirResource> create(String fhirProviderId, String fhirPath,
      FhirResource body) {
  ...
  public CompletableFuture<FhirResource> create(String fhirProviderId, String fhirPath,
    ...
    return this.rawClient.create(fhirProviderId, fhirPath, body, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<FhirResource> create(String fhirProviderId, String fhirPath,
    ...
    return this.rawClient.create(fhirProviderId, fhirPath, request, requestOptions).thenApply(response -> response.body());
  }
   ...
   * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
   */
  public CompletableFuture<FhirResource> upsert(String fhirProviderId, String fhirPath,
      FhirResource body) {
  ...
  public CompletableFuture<FhirResource> upsert(String fhirProviderId, String fhirPath,
      FhirResource body, RequestOptions requestOptions) {
    return this.rawClient.upsert(fhirProviderId, fhirPath, body, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<FhirResource> upsert(String fhirProviderId, String fhirPath,
    ...
    return this.rawClient.upsert(fhirProviderId, fhirPath, request, requestOptions).thenApply(response -> response.body());
  }
   ...
   */
  public CompletableFuture<Map<String, Object>> delete(String fhirProviderId, String fhirPath,
      FhirDeleteRequest request, RequestOptions requestOptions) {
    return this.rawClient.delete(fhirProviderId, fhirPath, request, requestOptions).thenApply(response -> response.body());
  }
   ...
   * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
   */
  public CompletableFuture<FhirResource> patch(String fhirProviderId, String fhirPath,
  ...
  public CompletableFuture<FhirResource> patch(String fhirProviderId, String fhirPath,
    ...
    return this.rawClient.patch(fhirProviderId, fhirPath, body, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<FhirResource> patch(String fhirProviderId, String fhirPath,
    ...
    return this.rawClient.patch(fhirProviderId, fhirPath, request, requestOptions).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<FhirBundle> executeBundle(String fhirProviderId, FhirBundle body,
      RequestOptions requestOptions) {
    return this.rawClient.executeBundle(fhirProviderId, body, requestOptions).thenApply(response -> response.body());
  }
   ...
   * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
   */
  public CompletableFuture<FhirBundle> executeBundle(String fhirProviderId,
  ...
  public CompletableFuture<FhirBundle> executeBundle(String fhirProviderId,
    ...
    return this.rawClient.executeBundle(fhirProviderId, request, requestOptions).thenApply(response -> response.body());
  }
}
