...
**provider:** `Optional<AgentCreateRequestProvider>` — FHIR provider type - can be a single provider or array of providers
...
**provider:** `Optional<AgentUpdateRequestProvider>` — FHIR provider type - can be a single provider or array of providers
