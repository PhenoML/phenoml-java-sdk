...
public class AsyncRawFhirClient {
  protected final ClientOptions clientOptions;

  public AsyncRawFhirClient(ClientOptions clientOptions) {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<FhirSearchResponse>> search(String fhirProviderId,
      String fhirPath) {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<FhirSearchResponse>> search(String fhirProviderId,
      String fhirPath, FhirSearchRequest request) {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<FhirSearchResponse>> search(String fhirProviderId,
      String fhirPath, FhirSearchRequest request, RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<PhenomlApiHttpResponse<FhirSearchResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirSearchResponse.class), response));
              return;
            }
            try {
              switch (response.code()) {
                ...
                return;
                case 502:future.completeExceptionally(new BadGatewayError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ErrorResponse.class), response));
                return;
              }
            }
     ...
     * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
     */
    public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> create(String fhirProviderId,
        String fhirPath, FhirResource body) {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> create(String fhirProviderId,
        String fhirPath, FhirResource body, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> create(String fhirProviderId,
        String fhirPath, FhirCreateRequest request) {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> create(String fhirProviderId,
        String fhirPath, FhirCreateRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<PhenomlApiHttpResponse<FhirResource>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirResource.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
       */
      public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> upsert(String fhirProviderId,
          String fhirPath, FhirResource body) {
       ...
       */
      public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> upsert(String fhirProviderId,
          String fhirPath, FhirUpsertRequest request) {
       ...
       */
      public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> upsert(String fhirProviderId,
          String fhirPath, FhirUpsertRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
         ...
         * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
         */
        public CompletableFuture<PhenomlApiHttpResponse<Map<String, Object>>> delete(
        ...
        public CompletableFuture<PhenomlApiHttpResponse<Map<String, Object>>> delete(
           ...
           * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
           */
          public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> patch(
          ...
          public CompletableFuture<PhenomlApiHttpResponse<FhirResource>> patch(
             ...
             * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
             */
            public CompletableFuture<PhenomlApiHttpResponse<FhirBundle>> executeBundle(
            ...
            public CompletableFuture<PhenomlApiHttpResponse<FhirBundle>> executeBundle(
              ...
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                CompletableFuture<PhenomlApiHttpResponse<FhirBundle>> future = new CompletableFuture<>();
                client.newCall(okhttpRequest).enqueue(new Callback() {
                  @Override
                  public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                    try (ResponseBody responseBody = response.body()) {
                      String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                      if (response.isSuccessful()) {
                        future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirBundle.class), response));
                        return;
                      }
                      try {
                        switch (response.code()) {
