...
public final class AgentGetChatMessagesRequestRole {
    public static final AgentGetChatMessagesRequestRole FUNCTION =
            new AgentGetChatMessagesRequestRole(Value.FUNCTION, "function");
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof AgentGetChatMessagesRequestRole
                        && this.string.equals(((AgentGetChatMessagesRequestRole) other).string));
    }
