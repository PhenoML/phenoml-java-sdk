...
public class AsyncRawToolsClient {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndCreateResponse>> createFhirResource(
  ...
  public CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndCreateResponse>> createFhirResource(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndCreateResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Lang2FhirAndCreateResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndCreateMultiResponse>> createFhirResourcesMulti(
    ...
    public CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndCreateMultiResponse>> createFhirResourcesMulti(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndCreateMultiResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Lang2FhirAndCreateMultiResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       */
      public CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndSearchResponse>> searchFhirResources(
      ...
      public CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndSearchResponse>> searchFhirResources(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          CompletableFuture<PhenomlApiHttpResponse<Lang2FhirAndSearchResponse>> future = new CompletableFuture<>();
          client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Lang2FhirAndSearchResponse.class), response));
                  return;
                }
                try {
                  switch (response.code()) {
         ...
         */
        public CompletableFuture<PhenomlApiHttpResponse<CohortResponse>> analyzeCohort(
