...
@JsonDeserialize(
    builder = GetConstrueCodesCodesystemSearchTextRequest.Builder.class
)
public final class GetConstrueCodesCodesystemSearchTextRequest {
  ...
  private GetConstrueCodesCodesystemSearchTextRequest(String q, Optional<String> version,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GetConstrueCodesCodesystemSearchTextRequest && equalTo((GetConstrueCodesCodesystemSearchTextRequest) other);
  }
