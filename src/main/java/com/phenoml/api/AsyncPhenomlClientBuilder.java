...
public class AsyncPhenomlClientBuilder {
     ...
     */
    public AsyncPhenomlClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncPhenomlClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncPhenomlClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncPhenomlClientBuilder logging(LogConfig logging) {
    ...
    public AsyncPhenomlClientBuilder instanceUrl(String instanceUrl) {
    ...
    public static final class _TokenAuth extends AsyncPhenomlClientBuilder {
    ...
    public static final class _CredentialsAuth extends AsyncPhenomlClientBuilder {
        ...
        public AsyncPhenomlClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new AsyncPhenomlClient(finalOptions);
        }
    }
