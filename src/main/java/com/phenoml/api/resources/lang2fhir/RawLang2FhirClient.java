...
public class RawLang2FhirClient {
   ...
   */
  public PhenomlApiHttpResponse<Map<String, Object>> create(CreateRequest request) {
  ...
  public PhenomlApiHttpResponse<Map<String, Object>> create(CreateRequest request,
     ...
     */
    public PhenomlApiHttpResponse<CreateMultiResponse> createMulti(CreateMultiRequest request) {
    ...
    public PhenomlApiHttpResponse<CreateMultiResponse> createMulti(CreateMultiRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateMultiResponse.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       */
      public PhenomlApiHttpResponse<SearchResponse> search(SearchRequest request) {
      ...
      public PhenomlApiHttpResponse<SearchResponse> search(SearchRequest request,
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
              return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SearchResponse.class), response);
            }
            try {
              switch (response.code()) {
                case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
         ...
         * </ul>
         */
        public PhenomlApiHttpResponse<Lang2FhirUploadProfileResponse> uploadProfile(
        ...
        public PhenomlApiHttpResponse<Lang2FhirUploadProfileResponse> uploadProfile(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Lang2FhirUploadProfileResponse.class), response);
              }
              try {
                switch (response.code()) {
                  case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
           ...
           */
          public PhenomlApiHttpResponse<Map<String, Object>> document(DocumentRequest request) {
