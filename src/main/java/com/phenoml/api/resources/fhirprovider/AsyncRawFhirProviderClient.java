        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderResponse.class), response));
              return;
            }
            try {
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderListResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
      ...
      public CompletableFuture<PhenoMLHttpResponse<FhirProviderResponse>> get(String fhirProviderId,
        ...
        public CompletableFuture<PhenoMLHttpResponse<FhirProviderDeleteResponse>> delete(
            ...
            client.newCall(okhttpRequest).enqueue(new Callback() {
              ...
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderDeleteResponse.class), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
          ...
          public CompletableFuture<PhenoMLHttpResponse<FhirProviderResponse>> addAuthConfig(
             ...
             * <p>Note: Sandbox providers cannot be modified.</p>
             */
            public CompletableFuture<PhenoMLHttpResponse<FhirProviderResponse>> setActiveAuthConfig(
                  ...
                  client.newCall(okhttpRequest).enqueue(new Callback() {
                    ...
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                      try (ResponseBody responseBody = response.body()) {
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderRemoveAuthConfigResponse.class), response));
                          return;
                        }
                        try {
                          switch (response.code()) {
