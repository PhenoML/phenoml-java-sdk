...
@JsonDeserialize(
    builder = FhirCreateRequest.Builder.class
)
public final class FhirCreateRequest {
  ...
  private FhirCreateRequest(Optional<String> phenomlOnBehalfOf,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FhirCreateRequest && equalTo((FhirCreateRequest) other);
  }
  ...
  public interface BodyStage {
    ...
    Builder from(FhirCreateRequest other);
  }
