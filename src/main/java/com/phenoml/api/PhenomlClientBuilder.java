...
public class PhenomlClientBuilder {
     ...
     */
    public PhenomlClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public PhenomlClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public PhenomlClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public PhenomlClientBuilder logging(LogConfig logging) {
    ...
    public PhenomlClientBuilder instanceUrl(String instanceUrl) {
    ...
    public static final class _TokenAuth extends PhenomlClientBuilder {
    ...
    public static final class _CredentialsAuth extends PhenomlClientBuilder {
        ...
        public PhenomlClient build() {
            ...
            ClientOptions finalOptions = ClientOptions.Builder.from(baseOptions)
                    ...
                    .build();
            return new PhenomlClient(finalOptions);
        }
    }
