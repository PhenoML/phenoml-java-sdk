...
public class RawFhirProviderClient {
   ...
   */
  public PhenomlApiHttpResponse<FhirProviderResponse> create(FhirProviderCreateRequest request) {
  ...
  public PhenomlApiHttpResponse<FhirProviderResponse> create(FhirProviderCreateRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderResponse.class), response);
        }
        try {
     ...
     */
    public PhenomlApiHttpResponse<FhirProviderListResponse> list() {
      return list(null);
    }
     ...
     * Sandbox providers return FhirProviderSandboxInfo.</p>
     */
    public PhenomlApiHttpResponse<FhirProviderListResponse> list(RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderListResponse.class), response);
          }
          try {
            switch (response.code()) {
              case 401:throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       */
      public PhenomlApiHttpResponse<FhirProviderResponse> get(String fhirProviderId) {
      ...
      public PhenomlApiHttpResponse<FhirProviderResponse> get(String fhirProviderId,
         ...
         */
        public PhenomlApiHttpResponse<FhirProviderDeleteResponse> delete(String fhirProviderId) {
        ...
        public PhenomlApiHttpResponse<FhirProviderDeleteResponse> delete(String fhirProviderId,
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderDeleteResponse.class), response);
              }
              try {
                switch (response.code()) {
                  case 401:throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
           ...
           */
          public PhenomlApiHttpResponse<FhirProviderResponse> addAuthConfig(String fhirProviderId,
          ...
          public PhenomlApiHttpResponse<FhirProviderResponse> addAuthConfig(String fhirProviderId,
             ...
             * <p>Note: Sandbox providers cannot be modified.</p>
             */
            public PhenomlApiHttpResponse<FhirProviderResponse> setActiveAuthConfig(
            ...
            public PhenomlApiHttpResponse<FhirProviderResponse> setActiveAuthConfig(
               ...
               * <p>Note: Sandbox providers cannot be modified.</p>
               */
              public PhenomlApiHttpResponse<FhirProviderRemoveAuthConfigResponse> removeAuthConfig(
              ...
              public PhenomlApiHttpResponse<FhirProviderRemoveAuthConfigResponse> removeAuthConfig(
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  try (Response response = client.newCall(okhttpRequest).execute()) {
                    ...
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderRemoveAuthConfigResponse.class), response);
                    }
                    try {
                      switch (response.code()) {
                        case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
