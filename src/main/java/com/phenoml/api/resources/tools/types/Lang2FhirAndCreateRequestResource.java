...
public final class Lang2FhirAndCreateRequestResource {
    ...
    public static final Lang2FhirAndCreateRequestResource AUTO =
            new Lang2FhirAndCreateRequestResource(Value.AUTO, "auto");
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof Lang2FhirAndCreateRequestResource
                        && this.string.equals(((Lang2FhirAndCreateRequestResource) other).string));
    }
