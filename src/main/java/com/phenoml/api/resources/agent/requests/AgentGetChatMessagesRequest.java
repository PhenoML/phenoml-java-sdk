...
@JsonDeserialize(
    builder = AgentGetChatMessagesRequest.Builder.class
)
public final class AgentGetChatMessagesRequest {
  ...
  private AgentGetChatMessagesRequest(String chatSessionId, Optional<Integer> numMessages,
      Optional<AgentGetChatMessagesRequestRole> role,
      Optional<AgentGetChatMessagesRequestOrder> order, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(AgentGetChatMessagesRequest other) {
    return chatSessionId.equals(other.chatSessionId) && numMessages.equals(other.numMessages) && role.equals(other.role) && order.equals(other.order);
  }
