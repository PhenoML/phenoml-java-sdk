...
public class AsyncRawConstrueClient {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<ConstrueUploadCodeSystemResponse>> uploadCodeSystem(
  ...
  public CompletableFuture<PhenomlApiHttpResponse<ConstrueUploadCodeSystemResponse>> uploadCodeSystem(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<PhenomlApiHttpResponse<ConstrueUploadCodeSystemResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ConstrueUploadCodeSystemResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<ExtractCodesResult>> extractCodes(
    ...
    public CompletableFuture<PhenomlApiHttpResponse<ExtractCodesResult>> extractCodes(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<PhenomlApiHttpResponse<ExtractCodesResult>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ExtractCodesResult.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       */
      public CompletableFuture<PhenomlApiHttpResponse<ListCodeSystemsResponse>> listAvailableCodeSystems(
          ) {
      ...
      public CompletableFuture<PhenomlApiHttpResponse<ListCodeSystemsResponse>> listAvailableCodeSystems(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          CompletableFuture<PhenomlApiHttpResponse<ListCodeSystemsResponse>> future = new CompletableFuture<>();
          client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListCodeSystemsResponse.class), response));
                  return;
                }
                try {
                  switch (response.code()) {
         ...
         */
        public CompletableFuture<PhenomlApiHttpResponse<GetCodeSystemDetailResponse>> getCodeSystemDetail(
            String codesystem) {
        ...
        public CompletableFuture<PhenomlApiHttpResponse<GetCodeSystemDetailResponse>> getCodeSystemDetail(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            CompletableFuture<PhenomlApiHttpResponse<GetCodeSystemDetailResponse>> future = new CompletableFuture<>();
            client.newCall(okhttpRequest).enqueue(new Callback() {
              @Override
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCodeSystemDetailResponse.class), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
           ...
           */
          public CompletableFuture<PhenomlApiHttpResponse<DeleteCodeSystemResponse>> deleteCustomCodeSystem(
              String codesystem) {
          ...
          public CompletableFuture<PhenomlApiHttpResponse<DeleteCodeSystemResponse>> deleteCustomCodeSystem(
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              CompletableFuture<PhenomlApiHttpResponse<DeleteCodeSystemResponse>> future = new CompletableFuture<>();
              client.newCall(okhttpRequest).enqueue(new Callback() {
                @Override
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                  try (ResponseBody responseBody = response.body()) {
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteCodeSystemResponse.class), response));
                      return;
                    }
                    try {
                      switch (response.code()) {
             ...
             */
            public CompletableFuture<PhenomlApiHttpResponse<ExportCodeSystemResponse>> exportCustomCodeSystem(
                String codesystem) {
            ...
            public CompletableFuture<PhenomlApiHttpResponse<ExportCodeSystemResponse>> exportCustomCodeSystem(
              ...
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                CompletableFuture<PhenomlApiHttpResponse<ExportCodeSystemResponse>> future = new CompletableFuture<>();
                client.newCall(okhttpRequest).enqueue(new Callback() {
                  @Override
                  public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                    try (ResponseBody responseBody = response.body()) {
                      String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                      if (response.isSuccessful()) {
                        future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ExportCodeSystemResponse.class), response));
                        return;
                      }
                      try {
                        switch (response.code()) {
               ...
               * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
               */
              public CompletableFuture<PhenomlApiHttpResponse<ListCodesResponse>> listCodesInACodeSystem(
                  String codesystem) {
              ...
              public CompletableFuture<PhenomlApiHttpResponse<ListCodesResponse>> listCodesInACodeSystem(
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  CompletableFuture<PhenomlApiHttpResponse<ListCodesResponse>> future = new CompletableFuture<>();
                  client.newCall(okhttpRequest).enqueue(new Callback() {
                    @Override
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                      try (ResponseBody responseBody = response.body()) {
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListCodesResponse.class), response));
                          return;
                        }
                        try {
                          switch (response.code()) {
                 ...
                 * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
                 */
                public CompletableFuture<PhenomlApiHttpResponse<GetCodeResponse>> getASpecificCode(
                    String codesystem, String codeId) {
                ...
                public CompletableFuture<PhenomlApiHttpResponse<GetCodeResponse>> getASpecificCode(
                  ...
                  HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                    ...
                    CompletableFuture<PhenomlApiHttpResponse<GetCodeResponse>> future = new CompletableFuture<>();
                    client.newCall(okhttpRequest).enqueue(new Callback() {
                      @Override
                      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                        try (ResponseBody responseBody = response.body()) {
                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                          if (response.isSuccessful()) {
                            future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCodeResponse.class), response));
                            return;
                          }
                          try {
                            switch (response.code()) {
                   ...
                   * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
                   */
                  public CompletableFuture<PhenomlApiHttpResponse<SemanticSearchResponse>> semanticSearchEmbeddingBased(
                  ...
                  public CompletableFuture<PhenomlApiHttpResponse<SemanticSearchResponse>> semanticSearchEmbeddingBased(
                    ...
                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                      ...
                      CompletableFuture<PhenomlApiHttpResponse<SemanticSearchResponse>> future = new CompletableFuture<>();
                      client.newCall(okhttpRequest).enqueue(new Callback() {
                        @Override
                        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                          try (ResponseBody responseBody = response.body()) {
                            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                            if (response.isSuccessful()) {
                              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SemanticSearchResponse.class), response));
                              return;
                            }
                            try {
                              switch (response.code()) {
                     ...
                     * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
                     */
                    public CompletableFuture<PhenomlApiHttpResponse<TextSearchResponse>> terminologyServerTextSearch(
                    ...
                    public CompletableFuture<PhenomlApiHttpResponse<TextSearchResponse>> terminologyServerTextSearch(
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                        ...
                        CompletableFuture<PhenomlApiHttpResponse<TextSearchResponse>> future = new CompletableFuture<>();
                        client.newCall(okhttpRequest).enqueue(new Callback() {
                          @Override
                          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            try (ResponseBody responseBody = response.body()) {
                              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                              if (response.isSuccessful()) {
                                future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TextSearchResponse.class), response));
                                return;
                              }
                              try {
                                switch (response.code()) {
