...
public class AsyncRawToolsClient {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> list(String mcpServerId) {
  ...
  public CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> list(String mcpServerId,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, McpServerToolResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> get(
    ...
    public CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> get(
       ...
       */
      public CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> delete(
          String mcpServerToolId) {
      ...
      public CompletableFuture<PhenomlApiHttpResponse<McpServerToolResponse>> delete(
         ...
         */
        public CompletableFuture<PhenomlApiHttpResponse<McpServerToolCallResponse>> call(
        ...
        public CompletableFuture<PhenomlApiHttpResponse<McpServerToolCallResponse>> call(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            CompletableFuture<PhenomlApiHttpResponse<McpServerToolCallResponse>> future = new CompletableFuture<>();
            client.newCall(okhttpRequest).enqueue(new Callback() {
              @Override
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, McpServerToolCallResponse.class), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
