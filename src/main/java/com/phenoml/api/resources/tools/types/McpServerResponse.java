...
@JsonDeserialize(
    builder = McpServerResponse.Builder.class
)
public final class McpServerResponse {
  ...
  private McpServerResponse(Optional<Boolean> success, Optional<String> message,
      Optional<McpServerResponseData> data, Map<String, Object> additionalProperties) {
