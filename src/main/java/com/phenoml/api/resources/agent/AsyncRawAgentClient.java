...
public class AsyncRawAgentClient {
     ...
     */
    public CompletableFuture<PhenoMLHttpResponse<Void>> streamChat(AgentStreamChatRequest request) {
     ...
     * tool_result, message_end, and error.
     */
    public CompletableFuture<PhenoMLHttpResponse<Void>> streamChat(
