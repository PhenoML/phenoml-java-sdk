...
public class AsyncRawFhir2OmopClient {
     ...
     * including provider specialty, country, and place of service, are not mapped.</p>
     ...
     * <code>urn:uuid</code>). Contained references are supported only for medication code
     ...
     * <code>diagnostics</code> with its source path and outcome.</p>
