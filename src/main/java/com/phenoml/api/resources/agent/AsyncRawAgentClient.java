...
public class AsyncRawAgentClient {
    ...
    public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> update(String id) {
        return update(id, AgentUpdateRequest.builder().build());
    }

    /**
     * Updates an existing agent's configuration
     */
    public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> update(String id, AgentUpdateRequest request) {
