...
public class RawChatClient {
     ...
     */
    public PhenomlClientHttpResponse<AgentChatResponse> send(AgentChatRequest request) {
     ...
     * Send a message to an agent and receive a JSON response.
     */
    public PhenomlClientHttpResponse<AgentChatResponse> send(AgentChatRequest request, RequestOptions requestOptions) {
     ...
     */
    public PhenomlClientHttpResponse<Iterable<AgentChatStreamEvent>> stream(AgentStreamChatRequest request) {
     ...
     * tool_result, message_end, and error.
     */
    public PhenomlClientHttpResponse<Iterable<AgentChatStreamEvent>> stream(
     ...
     */
    public PhenomlClientHttpResponse<ListMessagesResponse> listMessages(ListMessagesRequest request) {
     ...
     * Retrieves a list of chat messages for a given chat session
     */
    public PhenomlClientHttpResponse<ListMessagesResponse> listMessages(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new PhenomlClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListMessagesResponse.class), response);
            }
            try {
                switch (response.code()) {
                    case 401:
