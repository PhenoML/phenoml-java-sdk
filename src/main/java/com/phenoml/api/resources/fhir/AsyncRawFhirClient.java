...
public class AsyncRawFhirClient {
   ...
   */
  public CompletableFuture<PhenoMLHttpResponse<FhirSearchResponse>> search(String fhirProviderId,
      String fhirPath) {
  ...
  public CompletableFuture<PhenoMLHttpResponse<FhirSearchResponse>> search(String fhirProviderId,
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirSearchResponse.class), response));
              return;
            }
            try {
     ...
     * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
     */
    public CompletableFuture<PhenoMLHttpResponse<FhirResource>> create(String fhirProviderId,
    ...
    public CompletableFuture<PhenoMLHttpResponse<FhirResource>> create(String fhirProviderId,
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirResource.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
       */
      public CompletableFuture<PhenoMLHttpResponse<FhirResource>> upsert(String fhirProviderId,
          String fhirPath, FhirResource body) {
      ...
      public CompletableFuture<PhenoMLHttpResponse<FhirResource>> upsert(String fhirProviderId,
        ...
        public CompletableFuture<PhenoMLHttpResponse<Map<String, Object>>> delete(
            ...
            client.newCall(okhttpRequest).enqueue(new Callback() {
              ...
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<Map<String, Object>>() {}), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
           ...
           * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
           */
          public CompletableFuture<PhenoMLHttpResponse<FhirResource>> patch(String fhirProviderId,
              String fhirPath, List<FhirPatchRequestBodyItem> body) {
           ...
           */
          public CompletableFuture<PhenoMLHttpResponse<FhirResource>> patch(String fhirProviderId,
              String fhirPath, List<FhirPatchRequestBodyItem> body, RequestOptions requestOptions) {
           ...
           */
          public CompletableFuture<PhenoMLHttpResponse<FhirResource>> patch(String fhirProviderId,
              String fhirPath, FhirPatchRequest request) {
           ...
           */
          public CompletableFuture<PhenoMLHttpResponse<FhirResource>> patch(String fhirProviderId,
              String fhirPath, FhirPatchRequest request, RequestOptions requestOptions) {
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                client.newCall(okhttpRequest).enqueue(new Callback() {
                  ...
                  public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                    try (ResponseBody responseBody = response.body()) {
                      String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                      if (response.isSuccessful()) {
                        future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirBundle.class), response));
                        return;
                      }
                      try {
                        switch (response.code()) {
