...
public class AsyncPhenomlApiClient {
  ...
  public AsyncPhenomlApiClient(ClientOptions clientOptions) {
  ...
  public static AsyncPhenomlApiClientBuilder builder() {
    return new AsyncPhenomlApiClientBuilder();
  }
}
