...
public class RawConstrueClient {
   ...
   */
  public PhenomlApiHttpResponse<ConstrueUploadCodeSystemResponse> uploadCodeSystem(
  ...
  public PhenomlApiHttpResponse<ConstrueUploadCodeSystemResponse> uploadCodeSystem(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ConstrueUploadCodeSystemResponse.class), response);
        }
        try {
     ...
     */
    public PhenomlApiHttpResponse<ExtractCodesResult> extractCodes(ExtractRequest request) {
    ...
    public PhenomlApiHttpResponse<ExtractCodesResult> extractCodes(ExtractRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ExtractCodesResult.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       */
      public PhenomlApiHttpResponse<ListCodeSystemsResponse> listAvailableCodeSystems() {
      ...
      public PhenomlApiHttpResponse<ListCodeSystemsResponse> listAvailableCodeSystems(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
              return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListCodeSystemsResponse.class), response);
            }
            try {
              switch (response.code()) {
                case 401:throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
         ...
         */
        public PhenomlApiHttpResponse<GetCodeSystemDetailResponse> getCodeSystemDetail(
            String codesystem) {
        ...
        public PhenomlApiHttpResponse<GetCodeSystemDetailResponse> getCodeSystemDetail(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCodeSystemDetailResponse.class), response);
              }
              try {
                switch (response.code()) {
                  case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
           ...
           */
          public PhenomlApiHttpResponse<DeleteCodeSystemResponse> deleteCustomCodeSystem(
              String codesystem) {
          ...
          public PhenomlApiHttpResponse<DeleteCodeSystemResponse> deleteCustomCodeSystem(
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              try (Response response = client.newCall(okhttpRequest).execute()) {
                ...
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteCodeSystemResponse.class), response);
                }
                try {
                  switch (response.code()) {
                    case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
             ...
             */
            public PhenomlApiHttpResponse<ExportCodeSystemResponse> exportCustomCodeSystem(
                String codesystem) {
            ...
            public PhenomlApiHttpResponse<ExportCodeSystemResponse> exportCustomCodeSystem(
              ...
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                try (Response response = client.newCall(okhttpRequest).execute()) {
                  ...
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ExportCodeSystemResponse.class), response);
                  }
                  try {
                    switch (response.code()) {
                      case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
               ...
               * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
               */
              public PhenomlApiHttpResponse<ListCodesResponse> listCodesInACodeSystem(
                  String codesystem) {
              ...
              public PhenomlApiHttpResponse<ListCodesResponse> listCodesInACodeSystem(
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  try (Response response = client.newCall(okhttpRequest).execute()) {
                    ...
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListCodesResponse.class), response);
                    }
                    try {
                      switch (response.code()) {
                        case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
                 ...
                 * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
                 */
                public PhenomlApiHttpResponse<GetCodeResponse> getASpecificCode(String codesystem,
                    String codeId) {
                ...
                public PhenomlApiHttpResponse<GetCodeResponse> getASpecificCode(String codesystem,
                  ...
                  HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                    ...
                    try (Response response = client.newCall(okhttpRequest).execute()) {
                      ...
                      String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                      if (response.isSuccessful()) {
                        return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCodeResponse.class), response);
                      }
                      try {
                        switch (response.code()) {
                          case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
                   ...
                   * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
                   */
                  public PhenomlApiHttpResponse<SemanticSearchResponse> semanticSearchEmbeddingBased(
                  ...
                  public PhenomlApiHttpResponse<SemanticSearchResponse> semanticSearchEmbeddingBased(
                    ...
                    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                      ...
                      try (Response response = client.newCall(okhttpRequest).execute()) {
                        ...
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SemanticSearchResponse.class), response);
                        }
                        try {
                          switch (response.code()) {
                            case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
                     ...
                     * <p>Usage of CPT is subject to AMA requirements: see PhenoML Terms of Service.</p>
                     */
                    public PhenomlApiHttpResponse<TextSearchResponse> terminologyServerTextSearch(
                    ...
                    public PhenomlApiHttpResponse<TextSearchResponse> terminologyServerTextSearch(
                      ...
                      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                        ...
                        try (Response response = client.newCall(okhttpRequest).execute()) {
                          ...
                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                          if (response.isSuccessful()) {
                            return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, TextSearchResponse.class), response);
                          }
                          try {
                            switch (response.code()) {
                              case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
