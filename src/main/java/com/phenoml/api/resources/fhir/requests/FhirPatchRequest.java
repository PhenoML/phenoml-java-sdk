...
@JsonDeserialize(
    builder = FhirPatchRequest.Builder.class
)
public final class FhirPatchRequest {
  ...
  private FhirPatchRequest(Optional<String> phenomlOnBehalfOf, Optional<String> phenomlFhirProvider,
      List<FhirPatchRequestBodyItem> body, Map<String, Object> additionalProperties) {
