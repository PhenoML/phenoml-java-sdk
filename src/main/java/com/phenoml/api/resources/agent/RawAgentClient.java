...
public class RawAgentClient {
     ...
     * Retrieves a list of PhenoAgents belonging to the authenticated user
     */
    public PhenomlClientHttpResponse<AgentListResponse> list(ListRequest request) {
     ...
     * Retrieves a list of PhenoAgents belonging to the authenticated user
     */
    public PhenomlClientHttpResponse<AgentListResponse> list(ListRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
