...
public final class GetRequest {
    ...
    private GetRequest(Optional<String> cursor, Optional<Integer> limit, Map<String, Object> additionalProperties) {
        this.cursor = cursor;
        this.limit = limit;
    ...
    /**
     * @return Page size for the item-status page. Defaults to 20; values above 100 are clamped to 100.
     */
    @JsonProperty("limit")
    ...
    public static final class Builder {
        ...
        /**
         * <p>Page size for the item-status page. Defaults to 20; values above 100 are clamped to 100.</p>
         */
        ...
        public GetRequest build() {
            return new GetRequest(cursor, limit, additionalProperties);
        }
