...
public class RawToolsClient {
   ...
   */
  public PhenomlApiHttpResponse<McpServerToolResponse> list(String mcpServerId) {
  ...
  public PhenomlApiHttpResponse<McpServerToolResponse> list(String mcpServerId,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, McpServerToolResponse.class), response);
        }
        try {
     ...
     */
    public PhenomlApiHttpResponse<McpServerToolResponse> get(String mcpServerToolId) {
    ...
    public PhenomlApiHttpResponse<McpServerToolResponse> get(String mcpServerToolId,
       ...
       */
      public PhenomlApiHttpResponse<McpServerToolResponse> delete(String mcpServerToolId) {
      ...
      public PhenomlApiHttpResponse<McpServerToolResponse> delete(String mcpServerToolId,
         ...
         */
        public PhenomlApiHttpResponse<McpServerToolCallResponse> call(String mcpServerToolId,
        ...
        public PhenomlApiHttpResponse<McpServerToolCallResponse> call(String mcpServerToolId,
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, McpServerToolCallResponse.class), response);
              }
              try {
                switch (response.code()) {
