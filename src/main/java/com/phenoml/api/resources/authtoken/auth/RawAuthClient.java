...
public class RawAuthClient {
   ...
   */
  public PhenomlApiHttpResponse<AuthGenerateTokenResponse> generateToken(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthGenerateTokenResponse.class), response);
        }
        try {
