...
public class RawFhirClient {
   ...
   */
  public PhenomlApiHttpResponse<FhirSearchResponse> search(String fhirProviderId, String fhirPath) {
  ...
  public PhenomlApiHttpResponse<FhirSearchResponse> search(String fhirProviderId, String fhirPath,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirSearchResponse.class), response);
        }
        try {
     ...
     * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
     */
    public PhenomlApiHttpResponse<FhirResource> create(String fhirProviderId, String fhirPath,
        FhirResource body) {
    ...
    public PhenomlApiHttpResponse<FhirResource> create(String fhirProviderId, String fhirPath,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirResource.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
       */
      public PhenomlApiHttpResponse<FhirResource> upsert(String fhirProviderId, String fhirPath,
          FhirResource body) {
      ...
      public PhenomlApiHttpResponse<FhirResource> upsert(String fhirProviderId, String fhirPath,
         ...
         * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
         */
        public PhenomlApiHttpResponse<Map<String, Object>> delete(String fhirProviderId,
            String fhirPath) {
        ...
        public PhenomlApiHttpResponse<Map<String, Object>> delete(String fhirProviderId,
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, new TypeReference<Map<String, Object>>() {}), response);
              }
              try {
                switch (response.code()) {
                  case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
           ...
           * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
           */
          public PhenomlApiHttpResponse<FhirResource> patch(String fhirProviderId, String fhirPath,
          ...
          public PhenomlApiHttpResponse<FhirResource> patch(String fhirProviderId, String fhirPath,
             ...
             * <p>The request is proxied to the configured FHIR server with appropriate authentication headers.</p>
             */
            public PhenomlApiHttpResponse<FhirBundle> executeBundle(String fhirProviderId,
                FhirBundle body) {
            ...
            public PhenomlApiHttpResponse<FhirBundle> executeBundle(String fhirProviderId,
              ...
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                try (Response response = client.newCall(okhttpRequest).execute()) {
                  ...
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirBundle.class), response);
                  }
                  try {
                    switch (response.code()) {
                      case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
