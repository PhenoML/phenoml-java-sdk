...
public class AsyncRawAuthClient {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<AuthGenerateTokenResponse>> generateToken(
  ...
  public CompletableFuture<PhenomlApiHttpResponse<AuthGenerateTokenResponse>> generateToken(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      .addPathSegments("auth/token");if (requestOptions != null) {
      ...
      CompletableFuture<PhenomlApiHttpResponse<AuthGenerateTokenResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthGenerateTokenResponse.class), response));
              return;
            }
            try {
