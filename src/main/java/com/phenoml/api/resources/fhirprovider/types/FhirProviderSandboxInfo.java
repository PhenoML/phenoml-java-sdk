...
@JsonDeserialize(
    builder = FhirProviderSandboxInfo.Builder.class
)
public final class FhirProviderSandboxInfo {
  ...
  private FhirProviderSandboxInfo(Optional<String> id, Optional<String> name,
      Optional<String> description, Optional<String> provider, Optional<Boolean> isActive,
  ...
  private boolean equalTo(FhirProviderSandboxInfo other) {
    return id.equals(other.id) && name.equals(other.name) && description.equals(other.description) && provider.equals(other.provider) && isActive.equals(other.isActive);
  }
