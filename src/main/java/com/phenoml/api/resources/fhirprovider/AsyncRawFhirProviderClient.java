...
public class AsyncRawFhirProviderClient {
   ...
   */
  public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> create(
  ...
  public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> create(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<PhenomlApiHttpResponse<FhirProviderListResponse>> list() {
      return list(null);
    }
    ...
    public CompletableFuture<PhenomlApiHttpResponse<FhirProviderListResponse>> list(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        CompletableFuture<PhenomlApiHttpResponse<FhirProviderListResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
          @Override
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderListResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       */
      public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> get(
      ...
      public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> get(
         ...
         */
        public CompletableFuture<PhenomlApiHttpResponse<FhirProviderDeleteResponse>> delete(
            String fhirProviderId) {
        ...
        public CompletableFuture<PhenomlApiHttpResponse<FhirProviderDeleteResponse>> delete(
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            CompletableFuture<PhenomlApiHttpResponse<FhirProviderDeleteResponse>> future = new CompletableFuture<>();
            client.newCall(okhttpRequest).enqueue(new Callback() {
              @Override
              public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderDeleteResponse.class), response));
                    return;
                  }
                  try {
                    switch (response.code()) {
           ...
           */
          public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> addAuthConfig(
          ...
          public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> addAuthConfig(
             ...
             * <p>Note: Sandbox providers cannot be modified.</p>
             */
            public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> setActiveAuthConfig(
            ...
            public CompletableFuture<PhenomlApiHttpResponse<FhirProviderResponse>> setActiveAuthConfig(
               ...
               * <p>Note: Sandbox providers cannot be modified.</p>
               */
              public CompletableFuture<PhenomlApiHttpResponse<FhirProviderRemoveAuthConfigResponse>> removeAuthConfig(
              ...
              public CompletableFuture<PhenomlApiHttpResponse<FhirProviderRemoveAuthConfigResponse>> removeAuthConfig(
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  CompletableFuture<PhenomlApiHttpResponse<FhirProviderRemoveAuthConfigResponse>> future = new CompletableFuture<>();
                  client.newCall(okhttpRequest).enqueue(new Callback() {
                    @Override
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                      try (ResponseBody responseBody = response.body()) {
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          future.complete(new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, FhirProviderRemoveAuthConfigResponse.class), response));
                          return;
                        }
                        try {
                          switch (response.code()) {
