...
@JsonDeserialize(builder = UpsertRequest.Builder.class)
public final class UpsertRequest {
    ...
    public interface BodyStage {
        ...
        Builder from(UpsertRequest other);
    }
    ...
    public static final class Builder implements BodyStage, _FinalStage {
        ...
        public UpsertRequest build() {
            return new UpsertRequest(phenomlOnBehalfOf, phenomlFhirProvider, body, additionalProperties);
        }
