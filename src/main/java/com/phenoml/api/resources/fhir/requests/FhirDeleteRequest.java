...
@JsonDeserialize(
    builder = FhirDeleteRequest.Builder.class
)
public final class FhirDeleteRequest {
  ...
  private FhirDeleteRequest(Optional<String> phenomlOnBehalfOf,
      Optional<String> phenomlFhirProvider, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(FhirDeleteRequest other) {
    return phenomlOnBehalfOf.equals(other.phenomlOnBehalfOf) && phenomlFhirProvider.equals(other.phenomlFhirProvider);
  }
