...
@JsonDeserialize(
    builder = StepOperation.Builder.class
)
public final class StepOperation {
  ...
  private StepOperation(Optional<Lang2FhirSearchDefinition> searchDefinition,
  ...
  private boolean equalTo(StepOperation other) {
    return searchDefinition.equals(other.searchDefinition) && createDefinition.equals(other.createDefinition) && workflowDefinition.equals(other.workflowDefinition) && decisionDefinition.equals(other.decisionDefinition);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.searchDefinition, this.createDefinition, this.workflowDefinition, this.decisionDefinition);
  }
  ...
  public static final class Builder {
    ...
    public StepOperation build() {
      return new StepOperation(searchDefinition, createDefinition, workflowDefinition, decisionDefinition, additionalProperties);
    }
  }
}
