...
public class FhirProviderClient {
   ...
   */
  public FhirProviderResponse addAuthConfig(String fhirProviderId,
  ...
  public FhirProviderResponse addAuthConfig(String fhirProviderId,
    ...
    return this.rawClient.addAuthConfig(fhirProviderId, request, requestOptions).body();
  }
   ...
   * <p>Note: Sandbox providers cannot be modified.</p>
   */
  public FhirProviderResponse setActiveAuthConfig(String fhirProviderId,
  ...
  public FhirProviderResponse setActiveAuthConfig(String fhirProviderId,
    ...
    return this.rawClient.setActiveAuthConfig(fhirProviderId, request, requestOptions).body();
  }
   ...
   * <p>Note: Sandbox providers cannot be modified.</p>
   */
  public FhirProviderRemoveAuthConfigResponse removeAuthConfig(String fhirProviderId,
      FhirProviderRemoveAuthConfigRequest request) {
   ...
   */
  public FhirProviderRemoveAuthConfigResponse removeAuthConfig(String fhirProviderId,
      FhirProviderRemoveAuthConfigRequest request, RequestOptions requestOptions) {
    return this.rawClient.removeAuthConfig(fhirProviderId, request, requestOptions).body();
  }
}
