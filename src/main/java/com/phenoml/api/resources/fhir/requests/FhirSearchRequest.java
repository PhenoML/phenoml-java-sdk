...
@JsonDeserialize(
    builder = FhirSearchRequest.Builder.class
)
public final class FhirSearchRequest {
  ...
  private FhirSearchRequest(Optional<String> phenomlOnBehalfOf,
      Optional<String> phenomlFhirProvider, Optional<Map<String, Optional<String>>> queryParameters,
  ...
  private boolean equalTo(FhirSearchRequest other) {
    return phenomlOnBehalfOf.equals(other.phenomlOnBehalfOf) && phenomlFhirProvider.equals(other.phenomlFhirProvider) && queryParameters.equals(other.queryParameters);
  }
