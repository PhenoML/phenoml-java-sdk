...
public class PhenomlApiClient {
  ...
  public PhenomlApiClient(ClientOptions clientOptions) {
  ...
  public static PhenomlApiClientBuilder builder() {
    return new PhenomlApiClientBuilder();
  }
}
