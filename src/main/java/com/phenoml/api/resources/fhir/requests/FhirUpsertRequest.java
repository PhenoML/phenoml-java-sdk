...
@JsonDeserialize(
    builder = FhirUpsertRequest.Builder.class
)
public final class FhirUpsertRequest {
  ...
  private FhirUpsertRequest(Optional<String> phenomlOnBehalfOf,
      Optional<String> phenomlFhirProvider, FhirResource body,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FhirUpsertRequest && equalTo((FhirUpsertRequest) other);
  }
  ...
  private boolean equalTo(FhirUpsertRequest other) {
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull FhirResource body);

    Builder from(FhirUpsertRequest other);
  }

  public interface _FinalStage {
    FhirUpsertRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(FhirUpsertRequest other) {
    ...
    @java.lang.Override
    @JsonSetter("body")
    public _FinalStage body(@NotNull FhirResource body) {
    ...
    @java.lang.Override
    public FhirUpsertRequest build() {
      return new FhirUpsertRequest(phenomlOnBehalfOf, phenomlFhirProvider, body, additionalProperties);
    }
  }
}
