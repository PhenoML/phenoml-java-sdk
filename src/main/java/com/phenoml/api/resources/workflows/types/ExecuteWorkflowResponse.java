...
@JsonDeserialize(
    builder = ExecuteWorkflowResponse.Builder.class
)
public final class ExecuteWorkflowResponse {
  ...
  private ExecuteWorkflowResponse(Optional<Boolean> success, Optional<String> message,
      Optional<ExecuteWorkflowResponseResults> results, Map<String, Object> additionalProperties) {
