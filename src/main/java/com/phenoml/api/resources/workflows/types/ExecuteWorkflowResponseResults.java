...
@JsonDeserialize(builder = ExecuteWorkflowResponseResults.Builder.class)
public final class ExecuteWorkflowResponseResults {
    private final Optional<Map<String, Object>> steps;

    private final Map<String, Object> additionalProperties;

    private ExecuteWorkflowResponseResults(
            Optional<Map<String, Object>> steps, Map<String, Object> additionalProperties) {
        this.steps = steps;
