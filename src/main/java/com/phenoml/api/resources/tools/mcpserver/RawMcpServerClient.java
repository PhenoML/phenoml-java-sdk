...
public class RawMcpServerClient {
   ...
   */
  public PhenomlApiHttpResponse<McpServerResponse> create(McpServerCreateRequest request) {
  ...
  public PhenomlApiHttpResponse<McpServerResponse> create(McpServerCreateRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new PhenomlApiHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, McpServerResponse.class), response);
        }
        try {
     ...
     */
    public PhenomlApiHttpResponse<McpServerResponse> list() {
      return list(null);
    }
     ...
     * Lists all MCP servers for a specific user
     */
    public PhenomlApiHttpResponse<McpServerResponse> list(RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
       ...
       */
      public PhenomlApiHttpResponse<McpServerResponse> get(String mcpServerId) {
      ...
      public PhenomlApiHttpResponse<McpServerResponse> get(String mcpServerId,
         ...
         */
        public PhenomlApiHttpResponse<McpServerResponse> delete(String mcpServerId) {
