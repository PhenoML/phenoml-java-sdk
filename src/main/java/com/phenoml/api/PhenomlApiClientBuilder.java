...
public class PhenomlApiClientBuilder {
   ...
   * Sets token
   */
  public PhenomlApiClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public PhenomlApiClientBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public PhenomlApiClientBuilder url(String url) {
   ...
   */
  public PhenomlApiClientBuilder timeout(int timeout) {
   ...
   */
  public PhenomlApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public PhenomlApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public PhenomlApiClientBuilder addHeader(String name, String value) {
  ...
  public PhenomlApiClient build() {
    if (token == null) {
      throw new RuntimeException("Please provide token");
    }
    validateConfiguration();
    return new PhenomlApiClient(buildClientOptions());
  }
}
