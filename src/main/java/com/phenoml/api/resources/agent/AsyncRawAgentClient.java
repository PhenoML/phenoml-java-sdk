  ...
  public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> create(AgentCreateRequest request,
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AgentResponse.class), response));
              return;
            }
            try {
    ...
    public CompletableFuture<PhenoMLHttpResponse<AgentListResponse>> list(AgentListRequest request,
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AgentListResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
      ...
      public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> get(String id,
         ...
         */
        public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> update(String id,
        ...
        public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> update(String id,
          ...
          public CompletableFuture<PhenoMLHttpResponse<AgentDeleteResponse>> delete(String id,
              ...
              client.newCall(okhttpRequest).enqueue(new Callback() {
                ...
                public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                  try (ResponseBody responseBody = response.body()) {
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AgentDeleteResponse.class), response));
                      return;
                    }
                    try {
                      switch (response.code()) {
             ...
             */
            public CompletableFuture<PhenoMLHttpResponse<AgentResponse>> patch(String id,
                  ...
                  client.newCall(okhttpRequest).enqueue(new Callback() {
                    ...
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                      try (ResponseBody responseBody = response.body()) {
                        String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                        if (response.isSuccessful()) {
                          future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AgentChatResponse.class), response));
                          return;
                        }
                        try {
                          switch (response.code()) {
                    ...
                    client.newCall(okhttpRequest).enqueue(new Callback() {
                      ...
                      public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                        try (ResponseBody responseBody = response.body()) {
                          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                          if (response.isSuccessful()) {
                            future.complete(new PhenoMLHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AgentGetChatMessagesResponse.class), response));
                            return;
                          }
                          try {
                            switch (response.code()) {
